...
# El programa se ejecuta dos veces por cada test debido a que al usar
# Valgrind no se imprimen los "double-freed" en caso de haberlos.
# La primera impresión es sin Valgrind y la segunda con él.
